...
const LR_MODULES: StudyModule[] = [
  ...
  },
  {
    ...
    category: "LR",
    description: "Master the core components of an LSAT argument: main conclusion, premises, intermediate conclusions, and peripheral information. Learn to identify opposing viewpoints, concessions, and background information, and distinguish core from non-core elements.",
    drills: "6 practice questions",
    difficulty: "Foundational",
    estimatedHours: 4,
    keyTopics: ["Argument Core", "Main Conclusion", "Premise", "Intermediate Conclusion", "Peripheral Information", "Opposing Viewpoints", "Concession", "Background Information"],
  },
  {
  ...
  },
  {
    ...
    category: "LR",
    description: "Master the two types of necessary assumptions: bridge assumptions that connect premises to conclusions by introducing a new concept, and defender assumptions that protect the argument by eliminating potential objections. Learn to use the negation test to verify assumptions.",
    drills: "Assumption practice questions",
    difficulty: "Intermediate",
    estimatedHours: 6,
    keyTopics: ["Bridge Assumptions", "Defender Assumptions", "Necessary Assumptions", "Negation Test", "Premise-to-Conclusion connection", "Objection elimination"],
  },
  {
    id: "lr-sa",
  ...
  },
  {
    ...
    category: "LR",
    description: "Develop the critical mindset essential for LSAT Flaw questions. Learn to ask 'Why doesn't the support justify the point?' and describe flaws using precise language. Master the 'fails to consider' and 'takes for granted' frameworks for identifying and articulating reasoning errors.",
    drills: "18 practice questions",
    difficulty: "Intermediate",
    estimatedHours: 8,
    keyTopics: ["Critical Mindset", "Evaluating Arguments", "Identifying Flaws", "Fails to Consider", "Takes for Granted", "Bias in Argument Evaluation", "Conceptual Flaw Description"],
  },
  {
    id: "flaws-19",
