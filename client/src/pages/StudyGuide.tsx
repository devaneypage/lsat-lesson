...
const LR_MODULES: StudyModule[] = [
  ...
  {
    id: "lr-principle",
    title: "Principle Questions (Supporting / Apply)",
    category: "LR",
    description: "Supporting Principle questions ask you to select the general rule or principle that best supports or justifies the argument's conclusion. The correct principle must logically bridge the argument's premises to its conclusion — it functions like a sufficient assumption expressed as a general rule. Key approach: (1) identify the conclusion and the gap between premises and conclusion, (2) predict the type of principle needed to close that gap, (3) select the answer that, if true as a general rule, would make the conclusion follow. Wrong answer traps: principles that support a different conclusion, principles that are too narrow or too broad, and principles that address irrelevant considerations. Source: LSAT LR by Type, Vol. 3 (pp. 299–312), 39 questions with answer key.",
    drills: "4.SupportingPrincipleQuestions.pdf (39 questions, LR V.3 pp. 299–312)",
    difficulty: "Advanced",
    estimatedHours: 5,
    keyTopics: ["Principle application", "Sufficient assumption as general rule", "Bridging premises to conclusion", "Rule extraction", "Logical generalization", "Case analysis", "Scope of the principle"],
  },
  {
    id: "lr-conforms",
    title: "Reasoning Conforms To (Method — Statement)",
    category: "LR",
    description: "Reasoning Conforms To questions present a general principle or rule and ask which specific scenario best exemplifies or conforms to that principle. Unlike standard Method of Argument questions (which ask HOW an argument reasons), these ask WHICH situation matches a stated pattern of reasoning. Key approach: (1) identify the abstract structure of the stated principle — what type of action, relationship, or outcome it describes, (2) map each answer choice onto that abstract structure, (3) select the answer whose concrete situation matches the principle's logical form exactly. Common wrong answer traps: choices that involve the right topic but wrong logical structure, choices that partially match the principle, and choices that reverse the direction of the principle. Source: LSAT LR by Type, Vol. 3 (pp. 167–179), 39 questions with answer key.",
    drills: "5.ReasoningConformsToQuestions.pdf (39 questions, LR V.3 pp. 167–179)",
    difficulty: "Advanced",
    estimatedHours: 4,
    keyTopics: ["Abstract principle identification", "Structural mapping", "Concrete-to-abstract matching", "Logical form analysis", "Method vs. Conforms To distinction", "Principle exemplification"],
  },
  {
    id: "lr-resolve",
